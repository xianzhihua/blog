<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:71:"C:\wamp\www\tp5blog\public/../application/index\view\search\search.html";i:1541078108;s:59:"C:\wamp\www\tp5blog\application\index\view\common\meta.html";i:1531652336;s:58:"C:\wamp\www\tp5blog\application\index\view\common\top.html";i:1541078261;s:59:"C:\wamp\www\tp5blog\application\index\view\common\left.html";i:1541078290;s:60:"C:\wamp\www\tp5blog\application\index\view\common\right.html";i:1541076767;s:61:"C:\wamp\www\tp5blog\application\index\view\common\footer.html";i:1531924988;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
	<title>冼智铧 - <?php echo $keywords; ?></title>
...
<div id="gotop"><i class="glyphicon glyphicon-hand-up"></i></div>
	...
	<div class="margin-left-div">
		...
		<ul class="margin-left-ul">
			...
			<a href="http://www.zhihua.fun"><li><i class="glyphicon glyphicon-film"></i>智铧影视</li></a>
		</ul>
	</div>
	<div class="hr"></div>
	<div class="margin-left-div">
			...
			<div class="main-right">
				<div class="main-right-left">
					<div class="alert-bottom">
						<h4>搜索: <?php echo $keywords; ?></h4>
					</div>
					<div class="content cate_content">
					<?php if(is_array($searchares) || $searchares instanceof \think\Collection || $searchares instanceof \think\Paginator): $i = 0; $__LIST__ = $searchares;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
						<div class="panel panel-default">
							<div class="panel-heading">
								<a href="/tp5blog/public/index.php/article/<?php echo $vo['id']; ?>.html"><?php if($vo['pic']): ?><img src="/tp5blog/public/static<?php echo $vo['pic']; ?>" width="100%"><?php else: ?><img src="/tp5blog/public/static/error.jpg" width="100%"><?php endif; ?></a>
							</div>
							<div class="panel-body dec dec-div">
								<a href="/tp5blog/public/index.php/article/<?php echo $vo['id']; ?>.html"><h4><?php echo $vo['title']; ?></h4></a>
