<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"C:\wamp\www\tp5blog\public/../application/admin\view\article\lst.html";i:1530760955;s:58:"C:\wamp\www\tp5blog\application\admin\view\common\top.html";i:1530533047;s:59:"C:\wamp\www\tp5blog\application\admin\view\common\left.html";i:1530534245;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<button type="button" tooltip="添加文章" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('article/add'); ?>'"> <i class=""></i> Add
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center">
                                <?php if($vo['pic'] != ''): ?>
                                <img src="/tp5blog/public/static<?php echo $vo['pic']; ?>" height="20">
                                <?php else: ?>
                                暂无缩略图
                                <?php endif; ?>
                                </td>
