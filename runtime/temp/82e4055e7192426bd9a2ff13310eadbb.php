<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:73:"C:\wamp\www\tp5blog\public/../application/index\view\message\message.html";i:1531652155;s:59:"C:\wamp\www\tp5blog\application\index\view\common\meta.html";i:1531652336;s:58:"C:\wamp\www\tp5blog\application\index\view\common\top.html";i:1541078261;s:59:"C:\wamp\www\tp5blog\application\index\view\common\left.html";i:1541078329;s:60:"C:\wamp\www\tp5blog\application\index\view\common\right.html";i:1541076767;s:61:"C:\wamp\www\tp5blog\application\index\view\common\footer.html";i:1531924988;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
			...
			<div class="main-right">
				<div class="main-right-left">
					<div class="alert alert-warning">
						...
						<p>由于开启评论审核，所以评论不会立刻出现，请不要重复评论~</p>
					</div>
					<div class="content article-bigcontent cate_content">
						...
						<div class="row mes_div">
						    ...
						    <div class="col-sm-11 form">
						        <div class="row cookres" style="display: none;">
						            <div class="col-sm-4">
						                <input name="name" type="text" class="form-control" AUTOCOMPLETE="off" value="<?php echo \think\Request::instance()->session('zhihuas_name'); ?>" id="name" placeholder="昵称 / 输入QQ号快速补全">
						            </div>
						            <div class="col-sm-4">
						                <input name="email" type="text" class="form-control" AUTOCOMPLETE="off" value="<?php echo \think\Request::instance()->session('zhihuas_email'); ?>" id="email" placeholder="邮箱地址">
						            </div>
						            <div class="col-sm-4">
						                <input name="web" type="text" class="form-control" AUTOCOMPLETE="off" value="<?php echo \think\Request::instance()->session('zhihuas_web'); ?>" id="web" placeholder="你的网站">
						            </div>
						        </div>
						        <div class="row">
						            <div class="col-sm-12">
						        ...
						        <button class="btn btn-success" id="btn-success" data-articleid="0" style="margin-top: 15px;" <?php if(\think\Request::instance()->session('zhihuas_name')): ?> data-cookie="yes" <?php endif; ?> >提交</button>
						    </div>
						</div>
						<?php else: ?>
						<div class="row mes_div">
						...
						<div class='media' style="margin-left: <?php echo $vo['level']*25; ?>px;">
						    ...
						    <div class='media-body'>
						       <div class='media-heading'>
						           <p><a href="<?php echo $vo['web']; ?>" target="_blank"><?php echo $vo['name']; ?></a>
